...
def test_bench_pure_python(benchmark):
    result = benchmark(str_to_uci, EXAMPLE_PGN)

    assert result == EXPECTED_OUTPUT
def test_pyo3(benchmark):
    import san_to_uci
